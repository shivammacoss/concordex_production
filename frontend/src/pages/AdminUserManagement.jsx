...
const AdminUserManagement = () => {
  ...
  const fetchPasswordResetRequests = async () => {
    try {
      const response = await adminFetch('/admin/password-reset-requests')
      if (response.ok) {
        const data = await response.json()
  ...
  const handleProcessResetRequest = async (requestId, action) => {
    ...
    try {
      const response = await adminFetch(`/admin/password-reset-requests/${requestId}/process`, {
        method: 'PUT',
        body: JSON.stringify({
          action,
  ...
  const fetchUserAccounts = async (userId) => {
    try {
      const response = await adminFetch(`/trading-accounts/user/${userId}`)
      if (response.ok) {
        const data = await response.json()
  ...
  const fetchUserWallet = async (userId) => {
    try {
      const response = await adminFetch(`/wallet/${userId}`)
      if (response.ok) {
        const data = await response.json()
  ...
  const handleChangePassword = async () => {
    ...
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/users/${selectedUser._id}/password`, {
        method: 'PUT',
  ...
  const handleDeductFund = async () => {
    ...
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/users/${selectedUser._id}/deduct`, {
        method: 'POST',
        body: JSON.stringify({ 
  ...
  const handleAddFund = async () => {
    ...
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/users/${selectedUser._id}/add-fund`, {
        method: 'POST',
        body: JSON.stringify({ 
  ...
  const handleBlockUser = async () => {
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/users/${selectedUser._id}/block`, {
        method: 'PUT',
        body: JSON.stringify({ 
  ...
  const handleBanUser = async () => {
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/users/${selectedUser._id}/ban`, {
        method: 'PUT',
        body: JSON.stringify({ 
  ...
  const handleDeleteUser = async () => {
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/users/${selectedUser._id}`, {
        method: 'DELETE'
      })
  ...
  const handleAddCredit = async () => {
    ...
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/trading-account/${selectedAccountId}/add-credit`, {
        method: 'POST',
        body: JSON.stringify({ 
  ...
  const handleAddFundToAccount = async () => {
    ...
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/trading-account/${selectedAccountId}/add-fund`, {
        method: 'POST',
        body: JSON.stringify({ 
  ...
  const handleDeductFromAccount = async () => {
    ...
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/trading-account/${selectedAccountId}/deduct`, {
        method: 'POST',
        body: JSON.stringify({ 
          amount: parseFloat(accountFundAmount),
  ...
  const handleLoginAsUser = async () => {
    setActionLoading(true)
    try {
      const response = await adminFetch(`/admin/login-as-user/${selectedUser._id}`, {
        method: 'POST',
